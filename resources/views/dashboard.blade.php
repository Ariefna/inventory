        ...
        <div class="card shadow mb-4">
            ...
            <div class="table-responsive">
                <table class="table mb-0 text-center table-striped table-sm">
                    ...
                    <?php
                        if ($barang_min) :
                            foreach ($barang_min as $barang_min1) {
                                ?>
                                <tr>
                                    <td><?= $barang_min1->nama_barang; ?></td>
                                    <td><?= $barang_min1->stok; ?></td>
                                    <td>
                                    <a href="<?=URL::to('/');?>/barangmasuk/add/<?= $barang_min1->id_barang; ?>" class="btn btn-warning btn-sm"><i class="fa fa-plus"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php else : ?>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="table-responsive">
                <table class="table mb-0 table-sm table-striped text-center">
                    ...
                    <tbody>
                    <?php foreach ($barang_masuk as $barang_masuk1) : ?>
                            <tr>
                                <td><strong><?= $barang_masuk1->tanggal_masuk; ?></strong></td>
                                <td><?= $barang_masuk1->nama_barang; ?></td>
                                <td><span class="badge badge-success"><?= $barang_masuk1->jumlah_masuk; ?></span></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
            ...
            <div class="table-responsive">
                <table class="table mb-0 table-sm table-striped text-center">
                    ...
                    <?php foreach ($barang_keluar as $barang_keluar) : ?>
                            <tr>
                                <td><strong><?= $barang_keluar->tanggal_keluar; ?></strong></td>
                                <td><?= $barang_keluar->nama_barang; ?></td>
                                <td><span class="badge badge-danger"><?= $barang_keluar->jumlah_keluar; ?></span></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
